...
public class Calculator {
    public double calculate(double firstOperand, double secondOperand, char mathematicalOperator) {
        switch (mathematicalOperator) {
            ...
            default:
                throw new IllegalArgumentException("Unsupported operation :" + mathematicalOperator);
        }
    }
